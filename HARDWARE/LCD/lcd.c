...
//LCD的画笔颜色和背景色	   
u16 POINT_COLOR=0x0000;	//画笔颜色红色0000
u16 BACK_COLOR=0x0000;  //背景色 白色ffff  此背景色为字体背景色0000黑色
...
{ 					
	...
	|RCC_APB2Periph_GPIOE|RCC_APB2Periph_GPIOF|RCC_APB2Periph_GPIOG,ENABLE);//使能PORTB,D,E,G以及AFIO复用功能时钟
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5;				 //PB0 推挽输出 背光
	...
	|GPIO_Pin_5|GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_14|GPIO_Pin_15;				 //	//PORTD复用推挽输出  
	...
	|GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_13|GPIO_Pin_14|GPIO_Pin_15;				 //	//PORTD复用推挽输出  
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP; 		 //复用推挽输出   
 	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	...
	//////////////////////////////////////////////////////
	GPIO_SetBits(GPIOC,GPIO_Pin_5);//初始化屏幕
  ...
  FSMC_NORSRAMInit(&FSMC_NORSRAMInitStructure);  //初始化FSMC配置
	...
	LCD_Display_Dir(0);		//默认为0竖屏 1竖屏设置屏幕显示方向
	LCD_LED=1;				//点亮背光
	LCD_Clear(WHITE);
}  
//清屏函数
